...
local highlights = {
  DiyStatuslineModeNormal = { link = 'Cursor' },
  DiyStatuslineModeInsert = { link = 'DiffChange' },
  DiyStatuslineModeVisual = { link = 'DiffAdd' },
  DiyStatuslineModeReplace = { link = 'DiffDelete' },
  DiyStatuslineModeCommand = { link = 'DiffText' },
  DiyStatuslineModeOther = { link = 'IncSearch' },
  DiyStatuslineDevinfo = { link = 'StatusLine' },
  DiyStatuslineFilename = { link = 'StatusLineNC' },
  DiyStatuslineFileinfo = { link = 'StatusLine' },
  DiyStatuslineInactive = { link = 'StatusLineNC' },
}
...
function cmp.time()
  return time, "DiyStatuslineModeNormal"
end
...
function cmp.lsp()
  ...
  local names = vim.iter(attached_clients)
      ...
      :totable()
  return "[" .. table.concat(names, ", ") .. "]", "DiyStatuslineFileinfo"
end
